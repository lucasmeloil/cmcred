-- =========================================================================
-- MIGRATION: FIX AUTH.IDENTITIES EMAIL GENERATED COLUMN
-- =========================================================================
...
BEGIN
  ...
  IF v_existing_id IS NOT NULL THEN
    ...
    -- Garantir identidade no auth.identities (sem coluna email pois é gerada)
    INSERT INTO auth.identities (
      ...
      v_existing_id,
      v_existing_id,
      json_build_object('sub', v_existing_id::text, 'email', p_email)::jsonb,
      'email',
      p_email,
      now(),
      now(),
  ...
  -- Inserir identidade correspondente no auth.identities (sem coluna email)
  INSERT INTO auth.identities (
    id,
    user_id,
    identity_data,
